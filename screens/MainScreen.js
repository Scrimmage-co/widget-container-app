    ...
    return (
      <View style={CommonStyles.mainContainer}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
          <FlipButton imageSource={require('../assets/FlipButton_left.png')} effect={() => this.Flipping('Heads')}
                      disabled={this.state.isTurning} activeOpacity={this.state.isTurning ? 1 : 0.5}/>
          <FlipButton imageSource={require('../assets/FlipButton_right.png')} effect={() => this.Flipping('Tails')}
                      disabled={this.state.isTurning} activeOpacity={this.state.isTurning ? 1 : 0.5}/>
        </View>
      </View>
    );
